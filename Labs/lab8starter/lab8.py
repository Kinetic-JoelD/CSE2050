class CustomSet:
    ...
    def add(self, item):
        ...
        if item in self._L[idx_bkt]: return

        # Add item to end of bucket
        self._L[idx_bkt].append(item)
    ...
    def _rehash(self, new_buckets):
        ...
        New_Set = [[] for i in range(self._n_buckets)]
